...
dorita pentru interpretabilitate. Metoda graphical lasso rezolva ambele probleme \citep{friedman2008}.

\section{Problema de optimizare penalizata}

Metoda graphical lasso (GLasso), propusa de \citep{friedman2008}, estimeaza
...
concava. Prin urmare, functia obiectiv este strict concava pe domeniul
$\Theta \succ 0$, ceea ce implica unicitatea solutiei optime.
\end{proof}

\subsection{Algoritm de rezolvare}

Problema \eqref{eq:glasso} este rezolvata prin algoritmul de coordonate-ciclice
propus de \citep{friedman2008}. Ideea este de a optimiza alternant in fiecare
...
\texttt{glasso} \citep{friedman2019}, apelata in scriptul
...
Criteriul BIC adaptat pentru modele grafice gaussiene \citep{yuan2007} este:
\begin{equation}
...
\begin{proposition}[Consistenta, \citep{ravikumar2011}]
...
\]
si recupereaza structura corecta a grafului cu probabilitate care tinde la 1.
\end{proposition}
...
\citep{lauritzen1996,friedman2008}.
